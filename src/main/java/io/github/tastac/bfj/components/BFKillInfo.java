...
public class BFKillInfo
{
    ...
    public BFKillInfo(int id, int matchId, int sourcePlayerId, int targetPlayerId, int weaponId, double sourcePosX, double sourcePosY, double sourcePosZ, double targetPosX, double targetPosY, double targetPosZ)
    {
        this.id = id;
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof BFKillInfo)) return false;
        BFKillInfo that = (BFKillInfo) o;
